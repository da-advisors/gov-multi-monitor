...
# python scripts/extract_and_clean_links_from_multiple_urls.py "url1" "url2" "url3" --json extracted_links/sentinel_pulls/number/number_name.json
# python scripts/extract_and_clean_links_from_multiple_urls.py "url1" "url2" "url3" --json extracted_links/sentinel_pulls/number/number_name.json --yaml extracted_links/sentinel_pulls/number/number_name.yaml

# python scripts/extract_and_clean_links_from_multiple_urls.py \
# "url" \
# "url" \
# "url" \
